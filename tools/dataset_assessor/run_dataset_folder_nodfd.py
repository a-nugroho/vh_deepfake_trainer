    ...
    for id_now,key_now in enumerate(tqdm(list_path_images)):
        if key_now in data_result:
            ...
            try:
                ...
                img_cropped, _ = model_fd.extract_face(img, dets, angle, task="face-quality")
            ...
            try:
                ...
                dict_result["pred_skin_tone"] = result["faces"][0]["tone_label"]
            except:
                dict_result["pred_skin_tone"] = "UNKNOWN"
