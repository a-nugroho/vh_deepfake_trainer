...
ALT_MODULE_PATHS = {
    "face_deepfake": "/mnt/ssd/workspace/adi/repos/vh_deepfake_trainer/tools/evaluation_tools/face_deepfake",
...
from face_deepfake import DeepfakeDetectionCustomProd
from face_deepfake.engine_onnx import DeepfakeEngine_Generic

ENGINE_REF = {"clip_cip":{'engine_class':DeepfakeEngine_Generic,
        'input_size':(224, 224),
...
fdd = DeepfakeDetectionCustomProd(device_name="cuda",list_dict_engine=dicts_engine)
...
with open("_".join([Path(__file__).stem,"output.txt"]), "w", encoding="utf-8") as f:
